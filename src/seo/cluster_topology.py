...
_ANCHOR: dict[str, str] = {
    ...
    "/general-license-46-venezuela": "OFAC General License 46: Venezuela oil sanctions relief explained",

    "/invest-in-venezuela": "How to invest in Venezuela (2026 sanctions-safe guide)",
    "/venezuela-hydrocarbons-law": "Venezuela Hydrocarbons Law reform (2026 investor guide)",
    "/investing-in-venezuelan-oil": "Investing in Venezuelan oil — licensing, JVs, and due diligence",
    "/venezuela-bonds-restructuring": "Venezuela bond restructuring guide — sovereign and PDVSA debt",
    "/venezuela-bonds-tracker": "Venezuela Bonds Tracker — prices, milestones, and market news",
    "/venezuela-etf": "Venezuela ETF status and public-market alternatives",
    "/venezuela-vs-colombia": "Venezuela vs. Colombia investment comparison",
...
CLUSTERS: dict[str, Cluster] = {
    "sanctions": Cluster(
        ...
        members=(
            ...
            _ck("/general-license-46-venezuela", "What OFAC General License 46 authorizes for Venezuela oil-sector activity."),
    ...
    "investment": Cluster(
        ...
        members=(
            ...
            _ck("/general-license-46-venezuela", "The legal gate for U.S.-linked Venezuela oil-sector transactions."),
            _ck("/venezuela-hydrocarbons-law", "The regulatory framework for CPPs, PDVSA participation, tax, and arbitration."),
            _ck("/investing-in-venezuelan-oil", "Practical entry guide for oil investors evaluating licenses, partners, and risk."),
            _ck("/venezuela-bonds-restructuring", "The distressed-debt thesis for sovereign and PDVSA creditors."),
            _ck("/venezuela-bonds-tracker", "Daily tracker for public bond price references, milestones, and market news."),
            _ck("/venezuela-etf", "Retail-access angle: ETF status and public-company alternatives."),
            _ck("/venezuela-vs-colombia", "Allocation comparison for LatAm investors weighing risk and reward."),
